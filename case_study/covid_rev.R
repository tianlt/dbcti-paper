...
test_C1 <- distribution_estimation(test_C1, ndraw = 1000, expansion = 1, ... =c(4,5),c(2,3),6,1) 
test_C1 <- point_possibility(test_C1, r = 2)
test_C1 <- connect_cluster(test_C1, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
test_C2 <- distribution_estimation(test_C2, ndraw = 1000, expansion = 2, ... =c(2,3),c(1,4,5),6) 
test_C2 <- point_possibility(test_C2, r = 2)
test_C2 <- connect_cluster(test_C2, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
