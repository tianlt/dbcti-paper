...
saveRDS(test_hescmt, 'datasets/test_hescmt.rds')
...
saveRDS(test_stem_mouse_C57BL6_old, 'datasets/test_stem_mouse_C57BL6_old.rds')
...
test_camp1_batch1 <- distribution_estimation(test_camp1_batch1, ndraw = 1000, expansion = 5, ... = 5, 4, c(1, 2), 3)
test_camp1_batch1 <- point_possibility(test_camp1_batch1, r = 2)
test_camp1_batch1 <- connect_cluster(test_camp1_batch1, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
saveRDS(test_camp1_batch1@selected_feature$selected_gene, file = 'datasets/camp1_batch1_selected_gene.rds')
saveRDS(test_camp1_batch1, 'datasets/test_camp1_batch1.rds')
...
test_nestorowa_batch1_type_filter_no_stem <- point_possibility(test_nestorowa_batch1_type_filter_no_stem, r = 2)
test_nestorowa_batch1_type_filter_no_stem <- connect_cluster(test_nestorowa_batch1_type_filter_no_stem, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
saveRDS(test_nestorowa_batch1_type_filter_no_stem@selected_feature$selected_gene, file = 'datasets/nestorowa_batch1_type_filter_no_stem_selected_gene.rds')
saveRDS(test_nestorowa_batch1_type_filter_no_stem, 'datasets/test_nestorowa_batch1_type_filter_no_stem.rds')
...
test_yan <- distribution_estimation(test_yan, ndraw = 1000, expansion = 6, ... = c(1,2), 3, c(4,5), c(6,7,8)) 
test_yan <- point_possibility(test_yan, r = 2)
test_yan <- connect_cluster(test_yan, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
saveRDS(test_yan@selected_feature$selected_gene, file = 'datasets/yan_selected_gene.rds')
saveRDS(test_yan, 'datasets/test_yan.rds')
