...
test_bifurcating_cycle <- point_possibility(test_bifurcating_cycle, r = 2)
test_bifurcating_cycle <- connect_cluster(test_bifurcating_cycle, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
test_cycle <- point_possibility(test_cycle, r = 2)
test_cycle <- connect_cluster(test_cycle, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
test_disconnected <- distribution_estimation(test_disconnected, ndraw = 1000, expansion = 1.5, ... = c(3,4), 6, 5, 1, 2) 
test_disconnected <- point_possibility(test_disconnected, r = 2)
test_disconnected <- connect_cluster(test_disconnected, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
test_binary_tree <- point_possibility(test_binary_tree, r = 2)
test_binary_tree <- connect_cluster(test_binary_tree, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
test_linear <- point_possibility(test_linear, r = 2)
test_linear <- connect_cluster(test_linear, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
