...
bc_2_dbcti <- point_possibility(bc_2_dbcti, r = 2)
bc_2_dbcti <- connect_cluster(bc_2_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
bc_3_dbcti <- point_possibility(bc_3_dbcti, r = 2)
bc_3_dbcti <- connect_cluster(bc_3_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
l_2_dbcti <- point_possibility(l_2_dbcti, r = 2)
l_2_dbcti <- connect_cluster(l_2_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
l_3_dbcti <- point_possibility(l_3_dbcti, r = 2)
l_3_dbcti <- connect_cluster(l_3_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
c_2_dbcti <- point_possibility(c_2_dbcti, r = 2)
c_2_dbcti <- connect_cluster(c_2_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
c_3_dbcti <- point_possibility(c_3_dbcti, r = 2)
c_3_dbcti <- connect_cluster(c_3_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
d_2_dbcti <- distribution_estimation(d_2_dbcti, ndraw = 1000, expansion = 1.5, ... = 1,2) 
d_2_dbcti <- point_possibility(d_2_dbcti, r = 2)
d_2_dbcti <- connect_cluster(d_2_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
d_3_dbcti <- distribution_estimation(d_3_dbcti, ndraw = 1000, expansion = 1.5, ... = c(2,3),7,c(1,8),c(4,5,6)) 
d_3_dbcti <- point_possibility(d_3_dbcti, r = 2)
d_3_dbcti <- connect_cluster(d_3_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
bt_2_dbcti <- distribution_estimation(bt_2_dbcti, ndraw = 1000, expansion = 1, ... = 1,c(3,4),5,c(2,6)) 
bt_2_dbcti <- point_possibility(bt_2_dbcti, r = 2)
bt_2_dbcti <- connect_cluster(bt_2_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
...
bt_3_dbcti <- distribution_estimation(bt_3_dbcti, ndraw = 1000, expansion = 1, ... = 1,c(3,5),2,4,6) 
bt_3_dbcti <- point_possibility(bt_3_dbcti, r = 2)
bt_3_dbcti <- connect_cluster(bt_3_dbcti, sum_cri = 0.8, diff_cri = 0.5, vague_cri = 0.01)
