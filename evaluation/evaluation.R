...
distance_leng_r_4 <- calculate_l_distance_r(test_para_leng, r = 4)
distance_leng_r_5 <- calculate_l_distance_r(test_para_leng, r = 5)

total_l_dis_tb <- tibble(l_r_1 = distance_leng_r_1, 
                      l_r_2 = distance_leng_r_2, 
                      l_r_3 = distance_leng_r_3, 
                      l_r_4 = distance_leng_r_4, 
                      l_r_5 = distance_leng_r_5)
avg_l_dis_tb <- tibble(l_r_1 = distance_leng_r_1/length(leng_index), 
                         ...
                         l_r_4 = distance_leng_r_4/length(leng_index), 
                         l_r_5 = distance_leng_r_5/length(leng_index))
...
distance_nestorowa_r_4 <- calculate_n_distance_r(test_para_nestorowa, r = 4)
distance_nestorowa_r_5 <- calculate_n_distance_r(test_para_nestorowa, r = 5)

total_n_dis_tb <- tibble(l_r_1 = distance_nestorowa_r_1, 
                         l_r_2 = distance_nestorowa_r_2, 
                         l_r_3 = distance_nestorowa_r_3, 
                         l_r_4 = distance_nestorowa_r_4, 
                         l_r_5 = distance_nestorowa_r_5)
avg_n_dis_tb <- tibble(l_r_1 = distance_nestorowa_r_1/length(nestorowa_index), 
                       ...
                       l_r_4 = distance_nestorowa_r_4/length(nestorowa_index), 
                       l_r_5 = distance_nestorowa_r_5/length(nestorowa_index))
...
distance_kowalczyk_r_4 <- calculate_k_distance_r(test_para_kowalczyk, r = 4)
distance_kowalczyk_r_5 <- calculate_k_distance_r(test_para_kowalczyk, r = 5)

total_k_dis_tb <- tibble(l_r_1 = distance_kowalczyk_r_1, 
                         l_r_2 = distance_kowalczyk_r_2, 
                         l_r_3 = distance_kowalczyk_r_3, 
                         l_r_4 = distance_kowalczyk_r_4, 
                         l_r_5 = distance_kowalczyk_r_5)
avg_k_dis_tb <- tibble(l_r_1 = distance_kowalczyk_r_1/length(kowalczyk_index), 
                       ...
                       l_r_4 = distance_kowalczyk_r_4/length(kowalczyk_index), 
                       l_r_5 = distance_kowalczyk_r_5/length(kowalczyk_index))
...
distance_camp_r_4 <- calculate_c_distance_r(test_para_camp, r = 4)
distance_camp_r_5 <- calculate_c_distance_r(test_para_camp, r = 5)

total_c_dis_tb <- tibble(l_r_1 = distance_camp_r_1, 
                         l_r_2 = distance_camp_r_2, 
                         l_r_3 = distance_camp_r_3, 
                         l_r_4 = distance_camp_r_4, 
                         l_r_5 = distance_camp_r_5)
avg_c_dis_tb <- tibble(l_r_1 = distance_camp_r_1/length(camp_index), 
                       ...
                       l_r_4 = distance_camp_r_4/length(camp_index), 
                       l_r_5 = distance_camp_r_5/length(camp_index))
...
distance_yan_r_4 <- calculate_y_distance_r(test_para_yan, r = 4)
distance_yan_r_5 <- calculate_y_distance_r(test_para_yan, r = 5)

total_y_dis_tb <- tibble(l_r_1 = distance_yan_r_1, 
                         l_r_2 = distance_yan_r_2, 
                         l_r_3 = distance_yan_r_3, 
                         l_r_4 = distance_yan_r_4, 
                         l_r_5 = distance_yan_r_5)
avg_y_dis_tb <- tibble(l_r_1 = distance_yan_r_1/length(yan_index), 
                       ...
                       l_r_4 = distance_yan_r_4/length(yan_index), 
                       l_r_5 = distance_yan_r_5/length(yan_index))
#plot
r_value <- str_split(rownames(t(total_l_dis_tb)), '_') %>% 
            lapply(function(x) x[3]) %>%
            unlist() %>%
            as.numeric() 

total_l_dis_ggtb <- t(total_l_dis_tb) %>% tibble() %>%
...
total_n_dis_ggtb <- t(total_n_dis_tb) %>% tibble() %>%
...
total_k_dis_ggtb <- t(total_k_dis_tb) %>% tibble() %>%
...
total_c_dis_ggtb <- t(total_c_dis_tb) %>% tibble() %>%
...
total_y_dis_ggtb <- t(total_y_dis_tb) %>% tibble() %>%
...
#unadd
total_dis_ggtb <- total_l_dis_ggtb %>% 
  bind_rows(total_n_dis_ggtb)
avg_dis_ggtb <- avg_l_dis_ggtb %>% 
  bind_rows(avg_n_dis_ggtb)


total_dis_ggtb_plot <- ggplot() +  geom_line(data = total_dis_ggtb, aes(r_parameter, distance, fill = data, color = data), size = 3) +
...
plot(total_dis_ggtb_plot)

avg_dis_ggtb_plot <- ggplot() +  geom_line(data = avg_dis_ggtb, aes(r_parameter, distance, fill = data, color = data), size = 3) +
  # geom_point(data = total_dis_ggtb, aes(r_parameter, distance, fill = data, color = data), size = 5) +
  xlab('r value') + 
  ylab('Distance') + 
  ylim(0,0.1) +
...
pdf(file = 'nar_rev_diagram/avg_dis_ggtb_plot.pdf',width = 8,height = 6)
plot(avg_dis_ggtb_plot)#
dev.off()

#add
total_dis_aggtb <- total_l_dis_ggtb %>% 
  bind_rows(total_n_dis_ggtb) %>% 
  bind_rows(total_k_dis_ggtb) %>% 
  bind_rows(total_c_dis_ggtb) %>% 
  bind_rows(total_y_dis_ggtb)
...
total_dis_aggtb_plot <- ggplot() +  geom_line(data = total_dis_aggtb, aes(r_parameter, distance, fill = data, color = data), size = 3) +
  # geom_point(data = total_dis_ggtb, aes(r_parameter, distance, fill = data, color = data), size = 5) +
  ylab('Distance') + 
  theme_classic() +
  # geom_text(data = purity_ggdf, aes(dr, value, fill = data, label = data),position = position_dodge(.9), vjust = -0.2, size = 5.3) +
